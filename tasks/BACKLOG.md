...
- [ ] Add responsive/mobile QA for the case-study page. Run 43 is fully green at 1440/834/390px with HTTP 200, current H1, all required narrative headings, no runtime errors and no horizontal overflow. Retained full-page screenshots still need visual review before closing this item.
...
- [x] Optimize Alamaar evidence image delivery on the portfolio page. Commit `19637914b7ff6320aa443a89847387bd6b22eb36` routes Cloudinary image evidence through `f_auto/q_auto` after run 43 showed the original PNGs dominated an ~8.9 MB page payload.
...
- [ ] Run PageSpeed on final portfolio case-study page. Run 43 produced the first retained deployed-preview baseline (mobile Performance 80 / LCP 4.78s; desktop Performance 95 / LCP 1.32s), but it also exposed an ~8.9 MB payload dominated by original PNG evidence. Re-measure after image-delivery optimization commit `19637914b7ff6320aa443a89847387bd6b22eb36` before marking final PageSpeed complete.
